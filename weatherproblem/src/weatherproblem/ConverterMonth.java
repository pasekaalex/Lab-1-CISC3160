...
public class ConverterMonth {

		public static void main(String[] args) throws FileNotFoundException {
			//read month file, convert from F to C then C to F, and output to file
			float tempweek;
			Scanner week = new Scanner(new File("src/weathermonth.txt"));
			PrintWriter weekwriter = new PrintWriter(new File("src/monthconvert.txt"));
			int dayweek = 1;
			week.nextLine();
